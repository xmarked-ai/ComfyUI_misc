...
NF4BNB_CLASS_MAPPINGS = {
    "CheckpointLoaderNF4_X": CheckpointLoaderNF4_X,
    "UnetLoaderBNB_X": UnetLoaderBNB_X,
    "CheckpointLoaderBNB_X": CheckpointLoaderBNB_X,
}

NF4BNB_NAME_MAPPINGS = {
    "CheckpointLoaderNF4_X": "Checkpoint Loader NF4 X",
    "UnetLoaderBNB_X": "Unet Loader BNB X",
    "CheckpointLoaderBNB_X": "Checkpoint Loader BNB X",
}
