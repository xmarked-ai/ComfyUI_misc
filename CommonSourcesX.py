...
class CommonSourcesX:
    ...
    RETURN_NAMES = ("COND POSIVIVE", "COND NEGATIVE", "SEED", "STEPS", "CFG", "SAMPLER", "SCHEDULER", "LATENT", "WIDTH", "HEIGHT", "SEED",)
    FUNCTION = "common_sources"
    CATEGORY = "xmtools/nodes"

    def common_sources(self, clip, positive, negative, seed=None, steps=None, cfg=None, sampler_name=None, scheduler=None, width=None, height=None):
...
COMMONSRC_CLASS_MAPPINGS = {
    "CommonSourcesX": CommonSourcesX,
}

COMMONSRC_NAME_MAPPINGS = {
