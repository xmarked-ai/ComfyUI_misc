...
class SaveImageX:
    ...
    def save_images(self, images, filename_prefix="ComfyUI", subdirectory="", compress_level=4, prompt=None, extra_pnginfo=None):
        ...
        full_output_folder, filename, counter, subfolder, filename_prefix = folder_paths.get_save_image_path(filename_prefix, full_output_dir, images[0].shape[1], images[0].shape[0])
